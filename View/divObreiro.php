<div class="row g-3">
    <div class="row g-3">
        <label for="formFileMultiple" calss="form-label">Data de Batismo nas Águas:</label>
    ...
    <div class="row g-3">
        <div class="form-check form-check-inline">
            ...
            <label class="form-check-label" for="cargoSim">Auxiliar</label>
        </div>
        <div class="form-check form-check-inline">
            <input type="radio" id="cargoNao" name="cargo" class="form-check-input" value="nao">
            <label class="form-check-label" for="cargoNao">Diácono</label>
        </div>
    </div>
    <br>
    <div class="row g-3">
        <label for="formFileMultiple" class="form-label">batizado com Espirito Santo?</label>
    </div>
    <div class="row g-3">
        <div class="form-check form-check-inline">
            <input type="radio" id="cargoSim" name="cargo" class="form-check-input" value="sim">
    ...
    <div class="row g-3">
        <label for="formFileMultiple" class="form-label">Você possui algum cargo além de obreiro?</label>
    </div>
    <div class="row g-3">
        <div class="form-check form-check-inline">
            <input type="radio" id="cargoSim" name="cargo" class="form-check-input" value="sim">
